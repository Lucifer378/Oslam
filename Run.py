...
for z in range(200):
	...
	versi_chrome = str(random.randint(100,150))+".0."+str(random.randint(4999,5999))+"."+str(random.randint(100,200))
	...
	ua = f"Dalvik/2.1.0 (Linux; U; Android {android}; Fire2 LTE Build/{build}; wv) Build/OPD3.170816.012) [FBAN/MessengerLite;FBAV/{versi_chrome};FBPN/com.facebook.mlite;FBLC/de_DE;FBRV/{str(rr(123456789,987654321))};FBCR/Airtel;FBMF/Facebook;Facebook/Ige;FBDV/Fire2 LTE;FBSV/{android};FBCA]"
	if ua in ugent:pass
